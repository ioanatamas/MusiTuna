...
upld: $(BUILD_DIR)/musituna.hex
	$(info )
	$(info =========== ${BOARD} =============)
	dfu-programmer $(MCU) erase
	dfu-programmer $(MCU) flash $(BUILD_DIR)/musituna.hex

prom: $(BUILD_DIR)/musituna.eep upld
	$(info ======== EEPROM: ${BOARD} ========)
	dfu-programmer $(MCU) flash-eeprom $(BUILD_DIR)/musituna.eep
